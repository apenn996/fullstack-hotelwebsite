...
<?php  
	...
	if(isset($_POST['submit'])){
		...
		$spl="insert into `userlog`(HIS,NAME,DESCRIPTION,amenities,IMG) values('$HID','$NAME','$DESCRIPTION','$amenities','$IMG')";
                            ...
                            <div class="row">
								<div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" required class="form-control" name="HID" placeholder ="Enter Hotel ID">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Hotel Name</label>
                                        <input type="text" required class="form-control" name="NAME" placeholder ="Enter Hotel Name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
